...
$sql = "SELECT * FROM property WHERE userid = ? AND (type LIKE ? OR location LIKE ? OR price LIKE ?)";
    ...
    <main class="container">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p>Start by adding your first property to showcase it to potential buyers or renters.</p>
                <a href="add_property.php" class="btn btn-primary"><i class="fas fa-plus"></i> Add Property</a>
            </div>
        <?php endif; ?>
    </main>
